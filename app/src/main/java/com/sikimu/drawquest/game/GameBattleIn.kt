...
class GameBattleIn(worldData : WorldData): Game() {
    ...
    private var fillRectData : FillCenterRectData = FillCenterRectData(DrawAreaData(0F, 0F, 0F, 0F) , Color.argb(darkness,0,0,0))
    ...
    override fun update(motionEvent: GameMotionEvent) : Game {
        ...
        fillRectData = FillCenterRectData(DrawAreaData(0F, 0F, DrawParam.ScreenW, DrawParam.ScreenH) , Color.argb(darkness % 256, 0, 0, 0))
